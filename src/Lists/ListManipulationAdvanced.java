            ...
            switch (command) {
                ...
                case "Print":
                    ...
                    if (secondCommand.equals("even")) {
                        List<Integer> evenNumList = getEvenNumbers(numberList); //взема четните от метода
                        System.out.println(evenNumList.toString().replaceAll("[\\[\\],]", ""));
                    } else {
                        List<Integer> oddNumList = getOddNumbers(numberList); //нечетните от метода
                ...
                case "Filter":
                    ...
                    List<Integer> conditionalNumList = getConditionNumbers(numberList, condition, number);//метод
