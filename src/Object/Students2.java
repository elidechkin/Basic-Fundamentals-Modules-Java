...
public class Students2 {
    ...
    public static void main(String[] args) {
        ...
        List<Students.Student> studentList = new ArrayList<>();
        ...
        while (!input.equals("end")){
            ...
            Object.Students.Student currentStudent = new Object.Students.Student(firstName, lastName, age, town);

            //проверка за същ.обект
            studentList.add(currentStudent);

            input = scanner.nextLine();
        }
        String searchTown = scanner.nextLine();
        for (Object.Students.Student item:studentList) {
